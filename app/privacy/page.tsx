    ...
    <article className="content-page">
      ...
      <div className="shell article-grid">
        <div>
          ...
          <section><h2>Project briefs</h2><p>When you submit a brief, we store the project answers, company name, contact name, business email, optional phone number, consent record, shortlist and estimate. A person will review the request and may contact you about arranging comparable quotations. Your contact details are not automatically sent to suppliers.</p><p>A separate operational event history records the progress of a genuine enquiry, such as receipt, buyer follow-up, permission to share, supplier responses, quotations and any introduction fee. It uses the enquiry reference, service, time and bounded status information; contact details and questionnaire answers remain in the project brief rather than being copied into each event.</p></section>
          <section><h2>First-party product measurement</h2><p>We record page visits and a limited set of journey events on Vendor Atlas infrastructure: landing page viewed, assessment started and completed, results viewed, supplier viewed, and quote request started, completed or failed. Records contain the event name, server time, page and a small allowlist of result status, service, page type or supplier identifiers. They do not contain questionnaire answers, names, email addresses or phone numbers. These counts are used to test whether the service is useful and are not advertising profiles.</p></section>
