    ...
    <div className="results">
      ...
      <section className="price-card">
        <div>
          ...
          <p className="calibration-note">Early model, calibrated against three public provider ranges. Those ranges have different inclusions and are not independent market data. <a href="/dsear/cost">See the evidence and limitations</a>.</p>
        </div>
        <details>
      ...
      <section className="matches">
        ...
        <div className="matches-footer"><a href="/dsear/suppliers">Review the full UK evidence directory</a><span>{suppliers.length} providers checked · unknowns shown explicitly</span></div>
      </section>
      <div className="quote-cta">
        <div>
          ...
          <a className="quote-toolkit-link" href="/dsear/buying-toolkit">Or use the free buying toolkit yourself</a>
        </div>
        {!quoteOpen && (
